...
Первый параметр — вычитаемая дата, выражение типа [ДАТА](../../../прочее/датавремя/index.md);

Второй параметр — исходная дата, выражение типа [ДАТА](../../../прочее/датавремя/index.md);

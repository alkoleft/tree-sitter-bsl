...
Упорядочивание может осуществляться в порядке возрастания или убывания значений, а для таблиц, для которых задано свойство иерархичности — так же и по иерархии (описано в [Упорядочивание по иерархии](../../../текст-запроса/секция-упорядочить-по-упорядочивание-результатов/упорядочивание-по-иерархии/index.md)). <Порядок> может задаваться для каждого поля независимо.

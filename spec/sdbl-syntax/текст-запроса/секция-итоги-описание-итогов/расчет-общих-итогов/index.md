...
Для расчета итогов по всей таблице в предложении [ИТОГИ](../index.md) следует указать слово **ОБЩИЕ**. В этом случае будут вычислены значения [агрегатных функций](../../../использование-выражений-в-языке-запросов/агрегатные-функции/index.md) для всех записей таблицы.
